...
function CreateGroup() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: GroupFormValues) => userGroupService.create({
      ...data,
      memberIds: [],
      roleIds: []
    }),
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Create User Group</h2>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. West Coast Inspectors" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value={UserGroupType.Inspectors}>Inspectors</SelectItem>
                      <SelectItem value={UserGroupType.Instructors}>Instructors</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Group is active and can have members.
                    </FormDescription>
                  </div>
                </FormItem>
              )}
            ...
            <div className="flex justify-end gap-4">
              <Button type="button" variant="outline" onClick={() => navigate({ to: '/client/groups' })}>
                Cancel
              </Button>
