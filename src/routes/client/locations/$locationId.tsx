...
import type { UpdateLocationRequest } from "@/types/api/location";
		...
		<div className="max-w-4xl mx-auto space-y-6">
			<div className="flex items-center gap-4">
				<Button
					variant="ghost"
					size="icon"
					onClick={() => navigate({ to: "/client/locations" })}
				>
					...
					<div className="space-y-6">
						<div className="grid grid-cols-2 gap-x-8 gap-y-4">
							...
							<div>
								...
								<div
									className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${location.isActive ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
								>
