...
export function Sidebar() {
	const { selectedClientId, selectedClientName, clearClientContext } =
		useAdminStore();
		...
		<aside className="w-64 bg-slate-900 text-slate-300 flex flex-col h-screen border-r border-slate-800">
			...
			<div className="h-14 flex items-center px-4 border-b border-slate-800">
				<span className="font-bold text-white text-lg tracking-tight">
					InspectTec <span className="text-blue-500">Admin</span>
				</span>
			</div>
